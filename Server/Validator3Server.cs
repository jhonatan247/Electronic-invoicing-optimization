...
namespace Server
{
    public class Validator3Server
    {
        DataTable dtRequests;
        public Validator3Server()
        {
            dtRequests = Request.SelectValidator(3);
        ...
        public void Start()
        {
            ...
            {
                Console.WriteLine(DateTime.Now.ToLongTimeString() + " " + (dtRequests.Rows.Count-i) + " requests are in step 1, in the validator 3");
                Thread.Sleep(500);
            ...
            Console.WriteLine(DateTime.Now.ToLongTimeString() + " The validator 3 has no requests");
